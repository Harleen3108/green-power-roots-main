...
const contactDetails = [
  { icon: Phone, label: "Phone", val: "+91 90531 93317", color: "text-[#74C69D]" },
  { icon: Mail, label: "Email", val: "rameshwarenterprisessolution@gmail.com", color: "text-[#74C69D]" },
  { icon: MapPin, label: "Location", val: "2ND FLOOR BLK-B PKT-3 SEC-6 ROHINI CITY DELHI 110085 LANDMARK SHOP", color: "text-[#74C69D]" }
];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-500 max-w-xl mx-auto text-lg font-medium">
            Discuss your industrial requirements with our engineering team.
          </p>
        </motion.div>
