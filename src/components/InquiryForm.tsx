...
const InquiryForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const body = `Name: ${form.name}%0AEmail: ${form.email}%0APhone: ${form.phone}%0A%0AMessage:%0A${form.message}`;
    window.location.href = `mailto:info@rameshwarenterprises.com?subject=${encodeURIComponent(subject)}&body=${body}`;
  };
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-lg">
              Interested in our biodiesel plant? Fill out the form below and we'll get back to you.
            </p>
          </div>
