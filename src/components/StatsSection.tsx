...
const stats = [
  { icon: Factory, value: "50+", label: "Plants Installed" },
  { icon: Users, value: "100+", label: "Happy Clients" },
  { icon: MapPin, value: "15+", label: "States Served" },
...
const StatsSection = () => {
  return (
    <section className="relative py-40 overflow-hidden bg-white">
      {/* 🟢 FULL-WIDTH & "FAR" GREEN LAYER: Spans left-to-right and is vertically taller */}
      <motion.div 
